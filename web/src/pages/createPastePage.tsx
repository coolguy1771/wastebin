...
import { pasteValidationRules, formatExpiryTime, getExpiryOptions, getLanguageDisplayName, PASTE_CONSTRAINTS, type PasteFormData } from '../utils/validation';
      ...
      p: { xs: 2, md: 3, lg: 4 },
        ...
        <Paper sx={{ 
            ...
            <Box>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={values.burn}
                    onChange={(e) => getFieldProps('burn').onChange({ target: { value: e.target.checked } } as any)}
                  />
                }
                label={
                  <Box>
          ...
          <Box sx={{ mt: 'auto', pt: 2 }}>
            ...
            >
              {isSubmitting ? (
                <LoadingState variant="circular" size="small" />
              ) : (
                'Create Paste'
              )}
            </Button>
